...
from .checks import HealthChecker, HealthStatus, is_alive, is_ready, quick_health_check
...
class HealthHandler(BaseHTTPRequestHandler):
    ...
    def _handle_detailed_health(self):
        ...
        try:
            ...
            self._send_json_response(500, {
                "status": "error",
                "message": f"Detailed health check failed: {e!s}",
                "timestamp": time.time(),
            })
    ...
    def _handle_metrics(self):
        ...
        try:
            ...
            self._send_response(500, f"# Error generating metrics: {e!s}\n",
    ...
    def _handle_version(self):
        ...
        try:
            ...
            self._send_json_response(500, {
                "error": f"Failed to get version: {e!s}",
                "timestamp": time.time(),
            })
