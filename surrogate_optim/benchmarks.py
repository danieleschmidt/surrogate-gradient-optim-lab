...
from .core import SurrogateOptimizer, quick_optimize
...
from tests.fixtures.benchmark_functions import (
    BenchmarkFunction, benchmark_functions, get_2d_functions,
    get_multimodal_functions, get_high_dim_functions
)
...
class SurrogateBenchmarkSuite:
    ...
    def _save_summary_report(self, results: ComparisonResult, timestamp: str):
        ...
        with open(report_file, "w") as f:
            f.write(f"# Surrogate Optimization Benchmark Report\n\n")
